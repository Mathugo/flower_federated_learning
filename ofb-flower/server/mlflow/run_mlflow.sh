mlflow server -p 4040 -h 0.0.0.0 --backend-store-uri file:///Users/hugo/Documents/Programming/Orange/flower_federated_learning/ofb-flower/server/mlflow_storage
#TODO Sql server
