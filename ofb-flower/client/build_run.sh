...
sudo docker run -it --rm mathugo/ofb-flower --name usine_one --server_address localhost --server_port 4040 --cid 33 --model HugoNet --n_classes=3 --data_augmentation --mlflow_server_ip localhost --mlflow_server_port 4040